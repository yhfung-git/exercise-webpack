  ...
  _createClass(AlertService, [{
    ...
    value: function handleAdditionError(inputs, numbers) {
      var fullMessage = inputs.reduce(function (message, str, index) {
        if ((0,_utils_inputs_are_valid__WEBPACK_IMPORTED_MODULE_0__["default"])(numbers[index])) {
          return message + "";
        } else {
...
/* harmony import */ var _utils_inputs_are_valid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/inputs-are-valid */ "./src/app/utils/inputs-are-valid.js");
/* harmony import */ var _utils_parse_inputs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/parse-inputs */ "./src/app/utils/parse-inputs.js");
...
var run = function run(alertService, componentService) {
  ...
  componentService.onClick(function () {
    ...
    var parsedInputs = _utils_parse_inputs__WEBPACK_IMPORTED_MODULE_3__["default"].apply(void 0, _toConsumableArray(inputs));
    if (_utils_inputs_are_valid__WEBPACK_IMPORTED_MODULE_2__["default"].apply(void 0, _toConsumableArray(parsedInputs))) {
...
/******/ })()
;
//# sourceMappingURL=main.135db6ab36089a211fb9.bundle.js.map